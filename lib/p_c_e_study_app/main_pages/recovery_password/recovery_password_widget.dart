      ...
      child: Scaffold(
        ...
        appBar: responsiveVisibility(
          ...
          phone: false,
            ...
            ? AppBar(
                backgroundColor: const Color(0xFF301DD9),
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(20.0, 50.0, 20.0, 40.0),
                child: Text(
                  'We will sent you an Email with a link to reset your password, please enter the Email associated with your account below.',
