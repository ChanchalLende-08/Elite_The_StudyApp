...
import 'general_aptitude_model.dart';
export 'general_aptitude_model.dart';

class GeneralAptitudeWidget extends StatefulWidget {
  const GeneralAptitudeWidget({super.key});

  @override
  State<GeneralAptitudeWidget> createState() => _GeneralAptitudeWidgetState();
}

class _GeneralAptitudeWidgetState extends State<GeneralAptitudeWidget>
    with TickerProviderStateMixin {
  late GeneralAptitudeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GeneralAptitudeModel());
