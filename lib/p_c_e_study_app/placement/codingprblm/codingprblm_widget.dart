...
import 'codingprblm_model.dart';
export 'codingprblm_model.dart';

class CodingprblmWidget extends StatefulWidget {
  const CodingprblmWidget({super.key});

  @override
  State<CodingprblmWidget> createState() => _CodingprblmWidgetState();
}

class _CodingprblmWidgetState extends State<CodingprblmWidget>
    with TickerProviderStateMixin {
  late CodingprblmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CodingprblmModel());
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        await launchURL(
                                                            'https://www.codechef.com/practice/linked-lists');
                                                      },
                                                      child: Row(
                                                        mainAxisSize:
                                                            MainAxisSize.max,
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      await launchURL(
                                                          'https://www.naukri.com/code360/library/ninja-level');
                                                    },
                                                    child: Row(
                                                      mainAxisSize:
                                                          MainAxisSize.max,
