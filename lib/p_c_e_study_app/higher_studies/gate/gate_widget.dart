...
class _GateWidgetState extends State<GateWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GateModel());
                  ...
                  children: [
                    const Padding(
                      ...
                      child: FlutterFlowYoutubePlayer(
                        url: 'https://www.youtube.com/watch?v=0V3H-PlMpso&t=4s',
                        autoPlay: false,
                        looping: true,
                        mute: false,
                        showControls: true,
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              await launchURL('https://gate2024.iisc.ac.in/');
                            },
                            child: Container(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: const FlutterFlowWebView(
                          content: 'https://gate2024.iisc.ac.in/',
                          bypass: false,
                          height: 687.0,
                ...
                children: [
                  const Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 10.0, 10.0),
                    child: FlutterFlowYoutubePlayer(
                      url: 'https://www.youtube.com/watch?v=U1N6PDrChHE',
                      autoPlay: false,
                      looping: true,
                      mute: false,
                      showControls: true,
