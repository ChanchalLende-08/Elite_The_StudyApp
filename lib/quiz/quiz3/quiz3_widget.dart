    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Expanded(
              child: StreamBuilder<List<Quiz3Record>>(
                stream: queryQuiz3Record(
                  queryBuilder: (quiz3Record) =>
                      quiz3Record.orderBy('questionno'),
                ),
                builder: (context, snapshot) {
                  ...
                  List<Quiz3Record> containerQuiz3RecordList = snapshot.data!;
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: LinearPercentIndicator(
                                                ...
                                                center: Text(
                                                  '${_model.pageViewCurrentIndex.toString()}/${containerQuiz3RecordList.length.toString()}',
                                                            ...
                                                            padding:
                                                                const EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Question No.${quiz3DocsItem.questionno.toString()}',
