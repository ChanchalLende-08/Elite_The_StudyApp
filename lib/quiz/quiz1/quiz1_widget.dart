    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Expanded(
              child: StreamBuilder<List<Quiz1Record>>(
                stream: queryQuiz1Record(
                  queryBuilder: (quiz1Record) =>
                      quiz1Record.orderBy('questionno'),
                ),
                builder: (context, snapshot) {
                  ...
                  List<Quiz1Record> containerQuiz1RecordList = snapshot.data!;
                                        ...
                                        child: LinearPercentIndicator(
                                          percent: valueOrDefault<double>(
                                            _model.pageViewCurrentIndex /
                                                containerQuiz1RecordList.length,
                                            0.0,
                                          ),
                                          width: 330.0,
                                          lineHeight: 25.0,
                                          ...
                                          center: Text(
                                            '${_model.pageViewCurrentIndex.toString()}/${containerQuiz1RecordList.length.toString()}',
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                                            ...
                                                            padding:
                                                                const EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Question No.${quiz1DocsItem.questionno.toString()}',
