    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Expanded(
              child: StreamBuilder<List<Quiz5Record>>(
                stream: queryQuiz5Record(
                  queryBuilder: (quiz5Record) =>
                      quiz5Record.orderBy('question_no'),
                ),
                builder: (context, snapshot) {
                  ...
                  List<Quiz5Record> containerQuiz5RecordList = snapshot.data!;
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: LinearPercentIndicator(
                                                ...
                                                center: Text(
                                                  '${_model.pageViewCurrentIndex.toString()}/${containerQuiz5RecordList.length.toString()}',
                                                            ...
                                                            padding:
                                                                const EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Question No.${quiz5DocsItem.questionNo.toString()}',
