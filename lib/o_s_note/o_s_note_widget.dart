...
import 'o_s_note_model.dart';
export 'o_s_note_model.dart';

class OSNoteWidget extends StatefulWidget {
  const OSNoteWidget({super.key});

  @override
  State<OSNoteWidget> createState() => _OSNoteWidgetState();
}

class _OSNoteWidgetState extends State<OSNoteWidget> {
  late OSNoteModel _model;
