...
import 'p_os_model.dart';
export 'p_os_model.dart';
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 50.0, 0.0, 0.0),
                                                  child: Text(
                                                    'To create quality technocrats in the field of Computer Science & Engineering for education, research and training to meet industry and societal needs.\n',
                                                    textAlign: TextAlign.start,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        '1.\tTo create skilled and competent technocrats for mutual excellence involving the stakeholders to meet industrial needs.\n\n2.\tTo promote continuous learning in technical education for research activities in core and emerging areas.\n\n3.\tTo imbibe moral and ethical values to Computer Science Professionals for serving humanity.\n',
                                                        textAlign:
                                                            TextAlign.start,
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                            ...
                                            Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      10.0, 10.0, 10.0, 0.0),
                                              child: Text(
                                                'Identify, Formulate, review research literature and analyse complex engineering problems related to CSE and reaching substantiated conclusions using first principles of mathematics, natural sciences and engineering sciences.',
                                                textAlign: TextAlign.start,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 50.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      ' PEO1.\tOur graduates will be able to apply analysis, design, optimization and implementation skills in order to formulate and solve Computer Science and Engineering and multidisciplinary problems in industry.\n\nPEO2.\tOur graduates will be able to take up higher studies, research & development and other creative efforts in science & technology.\n\nPEO3.\tOur graduates will be able to use their skills in an ethical & professional manner for the welfare of the society.',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 50.0, 0.0, 0.0),
                                                  child: Text(
                                                    ' PSO1.\tPSO1\tTo acquire and demonstrate competence in programming technologies, skills in emerging areas.\n\nPSO2.\tTo demonstrate engineering practice to solve real life problems in various domains with open-source platform.',
                                                    textAlign:
                                                        TextAlign.justify,
                                                    style: FlutterFlowTheme.of(
                                                            context)
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(10.0, 25.0, 10.0, 25.0),
                child: InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed('semesterpage_study');
                  },
                  child: Container(
                    width: 350.0,
                    height: 70.0,
