...
import 'o_s_pyq_model.dart';
export 'o_s_pyq_model.dart';

class OSPyqWidget extends StatefulWidget {
  const OSPyqWidget({super.key});

  @override
  State<OSPyqWidget> createState() => _OSPyqWidgetState();
}

class _OSPyqWidgetState extends State<OSPyqWidget> {
  late OSPyqModel _model;
